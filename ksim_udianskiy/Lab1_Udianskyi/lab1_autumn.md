...
### Керуючі параметри:
**number-of-leaves** — параметр визначає кількість листя, яке буде присутнє в середовищі на початку симуляції. Регулюючи значення цього параметра за допомогою слайдера, можна змінювати кількість листя, яке проходитиме всі етапи симуляції.
**start-sugar-mean** — параметр задає середнє значення вмісту цукру в листі.
**start-sugar-stddev** — параметр визначає розкид (стандартне відхилення) початкового вмісту цукру в листі.
**temperature** — параметр задає температуру навколишнього середовища.
**rain-intensity** — параметр регулює інтенсивність дощу.
**wind-factor** — параметр визначає силу вітру в середовищі.
**sun-intensity** — параметр задає рівень інтенсивності сонячного випромінювання.
